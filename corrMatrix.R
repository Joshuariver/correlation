...
# https://www.r-bloggers.com/create-a-publication-ready-correlation-matrix-with-significance-levels-in-r/
...
correlation_matrix(mtcars[,1:7], digits = 2, use = 'lower', replace_diagonal = TRUE)


correlation_matrix(mtcars[,1:4], type = "spearman", show_significance = FALSE)
